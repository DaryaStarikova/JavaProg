...
class Processor {
    ...
    public void overclock(double newClockSpeed) {
        // Реализация метода для разгона процессора
...
class Memory {
    private int capacity; // в гигабайтах
    private String type;
    ...
    public void upgrade(int additionalCapacity) {
        // Реализация метода для увеличения объема памяти
...
class Monitor {
    ...
    public void adjustBrightness(int brightnessLevel) {
        // Реализация метода для регулировки яркости монитора
        // brightnessLevel - уровень яркости от 0 до 100
    }
}
